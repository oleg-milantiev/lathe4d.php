...
echo $lathe->cutRight(['y' => 48, 'dBegin' => 36]);		# отрезать справа всё, что y>48
...
echo $lathe->setCutter($cutter);
echo $lathe->cutLeft(['y' => 0, 'dBegin' => 36, 'dEnd' => 2]);		# отрезать слева всё, что y<0. То есть отрезать деталь
